angular.module('starter.controllers', ['ionic'])
        ...
        .controller('viewFeedbackWeeklyCtrl', function ($scope, $timeout, $ionicLoading, $ionicPopup, $state, $http, $stateParams) {
            ...
            $scope.init = function () {
                ...
                $http.post(url, {'feedback_type': 'Weekly', 'access_token': window.localStorage.getItem('auth_token'), 'idWeek': $scope.idWeek, 'spiritual_buddie_user_id': $scope.spiritualBuddieUserID}).success(function (res)
                {
                    $timeout(function () {
                        $ionicLoading.hide();
                        if (res.response == 'S') {
