...
var ViewFeedbackFormPage = /** @class */ (function () {
    ...
    ViewFeedbackFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-view-feedback-form',template:/*ion-inline-start:"/opt/lampp/htdocs/ionic3/src/pages/view-feedback-form/view-feedback-form.html"*/'<!--\n  Generated template for the MyBuddyWeeklyPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title><small style="font-size: 18px;">Weekly Feedback</small></ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="has-header has-header-inner1" >\n	<!-- [formGroup]="WeeklyForm" -->\n	<ion-scroll width="auto" scrollY style="height:600px;width: auto;">\n		<form   class="list login-form form1"  *ngIf="dataFound === true"> \n                <div class="list">\n\n        \n\n          <div id=""  >\n\n                <!-- feedbackWeeklyForm.feedback_field_1.$error.required ? \'has-error\' : \'\' -->        \n           <label  class="item item-input item-stacked-label" > \n            <span class="input-label" style="white-space:pre-wrap;">{{label_1}}</span>\n               <!--  <input readonly="readonly" type="text" class="" id="feedback_field_1" name="feedback_field_1"  [(ngModel)]="value_1"  > -->\n\n                 <input readonly="readonly" type="text" class="" id="feedback_field_1" name="feedback_field_1"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" [(ngModel)]="value_1">\n\n           </label>\n          </div>\n\n\n\n          <div >\n               <label  class="item item-input item-stacked-label" > \n                <span class="input-label" style="white-space:pre-wrap;">{{label_2}}</span>\n                <input readonly="readonly" type="text" class="" id="feedback_field_2" name="feedback_field_2"  [(ngModel)]="value_2"  >\n               </label>\n            </div>\n\n\n\n       <div class="row form-stacked-row">\n           <div class="col legend-box">\n                 <span class="legend-box-heading"> </span>\n             <div class="row form-stacked-row">\n\n                      <div class="col col-50">\n                          <div>       <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_3}}</span>\n                                <input readonly="readonly" type="text" class="" id="feedback_field_3" name="feedback_field_3"  [(ngModel)]="value_3" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                              </label>\n                          </div>\n                      </div>\n\n                      <div class="col col-50">\n                        <div>    <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_4}}</span>\n                            <input readonly="readonly" type="text" class="" id="feedback_field_4" name="feedback_field_4"  [(ngModel)]="value_4" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                          </label>\n                        </div>\n                           </div>\n            </div>\n\n          </div>\n        </div>\n\n\n\n               <div>  \n                      <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_5}}</span>\n                                        <input readonly="readonly" class="" type="text" id="feedback_field_5" name="feedback_field_5"  [(ngModel)]="value_5" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                    </label>\n                </div>\n         \n         \n                        <div >\n                            <label class="item item-input item-stacked-label"> \n                            <span class="input-label" style="white-space:pre-wrap;">{{label_6}}</span>\n                <input readonly="readonly" type="text" class="" id="feedback_field_6" name="feedback_field_6"  [(ngModel)]="value_6" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />\n                          </label>\n                        </div>\n                         \n\n                        \n                           <div>      <label class="item item-input item-stacked-label"> \n                                  <span class="input-label" style="white-space:pre-wrap;"> {{label_7}}</span>\n                <input readonly="readonly" type="text" class="" id="feedback_field_7" name="feedback_field_7"  [(ngModel)]="value_7" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />\n                              </label>\n                          </div>\n                    \n                    \n                       <div *ngIf="value_8 != null" >    \n                        <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_8}}</span>\n                <input readonly="readonly" type="text" class="" id="feedback_field_8" name="feedback_field_8"  [(ngModel)]="value_8" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />\n                          </label>\n                        </div>\n                   \n\n\n            <div *ngIf="value_9 != null">\n                <label  class="item item-input item-stacked-label" > \n                <span class="input-label" style="white-space:pre-wrap;">{{label_9}}</span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_9" name="feedback_field_9"  [(ngModel)]="value_9" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"  >\n               </label>\n    \n            </div>\n       \n\n\n            <div *ngIf="value_9 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;"> {{label_10}}  </span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_10" name="feedback_field_10"  [(ngModel)]="value_10" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n               </label>\n            \n                   \n                \n            </div>\n      \n\n       <div *ngIf="value_11 != null && value_12 != null && value_13 != null && value_14 != null && value_15 != null && value_16 != null" class="row form-stacked-row" >\n           <div class="col legend-box">\n                 <span class="legend-box-heading"></span>\n             <div class="row form-stacked-row">\n\n                      <div class="col col-50">\n                          <div *ngIf="value_10 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_11}}</span>\n                                 <input readonly="readonly" type="text" class="" id="feedback_field_11" name="feedback_field_11"  [(ngModel)]="value_11" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                              </label>\n                          </div>\n                      </div>\n\n                      <div class="col col-50">\n                        <div *ngIf="value_11 != null">\n                           <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_12}}</span>\n                             \n                             <input readonly="readonly" type="text" class="" id="feedback_field_12" name="feedback_field_12"  [(ngModel)]="value_12" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                          </label>\n                        </div>\n                           </div>\n             </div>\n\n              <div class="row form-stacked-row"> \n                        <div class="col col-50">\n                          <div *ngIf="value_13 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_13}}</span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_13" name="feedback_field_13"  [(ngModel)]="value_13" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                              </label>\n                          </div>\n                      </div>\n\n                        <div class="col col-50">\n                          <div *ngIf="value_14 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_14}}</span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_14" name="feedback_field_14"  [(ngModel)]="value_14" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                              </label>\n                          </div>\n                      </div>\n              </div>\n\n              <div class="row form-stacked-row"> \n\n                        <div class="col col-50">\n                          <div *ngIf="value_15 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_15}}</span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_15" name="feedback_field_15"  [(ngModel)]="value_15" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                              </label>\n                          </div>\n                      </div>\n\n                        <div class="col col-50">\n                          <div *ngIf="value_16 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_16}}</span>\n                 <input readonly="readonly" type="text" class="" id="feedback_field_16" name="feedback_field_16"  [(ngModel)]="value_16" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                              </label>\n                          </div>\n                      </div>\n\n              </div>\n\n\n          </div>\n        </div>\n\n\n\n\n\n           <div *ngIf="value_17 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_17}}</span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_17" name="feedback_field_17"  [(ngModel)]="value_17" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n \n\n\n            <div *ngIf="value_18 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_18}}</span>\n                 \n              <input readonly="readonly" type="text" class="" id="feedback_field_18" name="feedback_field_18"  [(ngModel)]="value_18" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n\n\n            <div *ngIf="value_19 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_19}}</span>\n                 \n                  <input readonly="readonly" type="text" class="" id="feedback_field_19" name="feedback_field_19"  [(ngModel)]="value_19" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n   \n\n\n            <div *ngIf="value_20 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_20}}</span>                 \n                  <input readonly="readonly" type="text" class="" id="feedback_field_20" name="feedback_field_20"  [(ngModel)]="value_20" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n\n\n\n            <div *ngIf="value_21 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_21}}</span>\n                             \n             <input readonly="readonly" type="text" class="" id="feedback_field_21" name="feedback_field_21"  [(ngModel)]="value_21" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n\n\n\n            <div *ngIf="value_22 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_22}}</span>\n                 \n                 <input readonly="readonly" type="text" class="" id="feedback_field_22" name="feedback_field_22"  [(ngModel)]="value_22" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n\n                \n             \n\n\n\n\n\n\n       <div  *ngIf="value_23 != null && value_24 != null && value_25 != null && value_26 != null && value_27 != null"  class="row form-stacked-row">\n           <div class="col legend-box">\n                 <span class="legend-box-heading"> </span>\n\n             <div class="row form-stacked-row">\n                      <div class="col col-50">\n                          <div *ngIf="value_23 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_23}}</span>\n                                  <input readonly="readonly" type="text" class="" id="feedback_field_23" name="feedback_field_23"  [(ngModel)]="value_23" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                              </label>\n                          </div>\n                      </div>\n\n                      <div class="col col-50">\n                        <div *ngIf="value_24 != null">\n                           <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_24}}</span>\n                             <input readonly="readonly" type="text" class="" id="feedback_field_24" name="feedback_field_24"  [(ngModel)]="value_24" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                          </label>\n                        </div>\n                           </div>\n             </div>\n\n\n             <div class="row form-stacked-row">\n\n                      <div class="col col-50">\n                          <div *ngIf="value_25 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_25}}</span>\n                                 <input readonly="readonly" type="text" class="" id="feedback_field_25" name="feedback_field_25"  [(ngModel)]="value_25" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                              </label>\n                          </div>\n                      </div>\n\n                      <div class="col col-50">\n                        <div id="">\n                           <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">  </span>\n                             \n                          </label>\n                        </div>\n                           </div>\n\n\n             </div>\n\n             <div class="row form-stacked-row">\n                      <div class="col">\n                        <div *ngIf="value_26 != null">\n                           <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;">{{label_26}}</span>\n                             <input readonly="readonly" type="text" class="" id="feedback_field_26" name="feedback_field_26"  [(ngModel)]="value_26" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                          </label>\n                        </div>\n                           </div>\n              </div>\n\n             <div class="row form-stacked-row">\n\n                      <div class="col ">\n                          <div *ngIf="value_27 != null">\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;"> {{label_27}} </span>\n                                  <input readonly="readonly" type="text" class="" id="feedback_field_27" name="feedback_field_27"  [(ngModel)]="value_27" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                              </label>\n                          </div>\n                      </div>\n\n                 \n             </div>\n          </div>\n        </div>\n\n\n\n\n\n\n\n            <div *ngIf="value_28 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;"> {{label_28}} </span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_28" name="feedback_field_28"  [(ngModel)]="value_28" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n             \n\n\n\n\n\n\n           <div *ngIf="value_29 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;" > {{label_29}}</span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_29" name="feedback_field_29"  [(ngModel)]="value_29" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n          \n\n\n            <div *ngIf="value_30 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_30}}</span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_30" name="feedback_field_30"  [(ngModel)]="value_30" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n           \n\n\n\n            <div *ngIf="value_31 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_31}}</span>\n                 \n                 <input readonly="readonly" type="text" class="" id="feedback_field_31" name="feedback_field_31"  [(ngModel)]="value_31" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n         \n\n\n\n            <div *ngIf="value_32 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">  {{label_32}}     </span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_32" name="feedback_field_32"  [(ngModel)]="value_32" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n            \n\n\n\n            <div *ngIf="value_33 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_33}}</span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_33" name="feedback_field_33"  [(ngModel)]="value_33" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n\n\n\n\n            <div *ngIf="value_34 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">    {{label_34}}     </span>\n                 \n                <input readonly="readonly" type="text" class="" id="feedback_field_34" name="feedback_field_34"  [(ngModel)]="value_34" ng-minlength="1" ng-maxlength="255" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n               </label>\n            </div>\n                \n\n\n\n\n\n        \n            <div *ngIf="value_35 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;">{{label_35}}</span>\n                 \n                 <textarea class="" rows="8" cols="10" id="feedback_field_35" name="feedback_field_35" [(ngModel)]="value_35"  ></textarea>\n\n               </label>\n            </div>\n                \n                  \n\n            </div>\n	</form>\n\n	 <div class="list list1" *ngIf="dataFound === false">\n            <div class="no-box">  <img src=\'assets/imgs/icon-no-comment.png\'><div class="clearfix"> </div>\n            <h3 class="text-center">Feedback not given for this week.</h3> \n             </div>\n        </div>\n</ion-scroll>\n</ion-content>\n'/*ion-inline-end:"/opt/lampp/htdocs/ionic3/src/pages/view-feedback-form/view-feedback-form.html"*/,
        }),
...
var ViewFeedbackFormMonthlyPage = /** @class */ (function () {
    ...
    ViewFeedbackFormMonthlyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-view-feedback-form-monthly',template:/*ion-inline-start:"/opt/lampp/htdocs/ionic3/src/pages/view-feedback-form-monthly/view-feedback-form-monthly.html"*/'<!--\n  Generated template for the MyBuddyWeeklyPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title><small style="font-size: 18px;">Monthly Feedback</small></ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="has-header has-header-inner1" >\n	<!-- [formGroup]="WeeklyForm" -->\n	<ion-scroll width="auto" scrollY style="height:600px;width: auto;">\n		<form   class="list login-form form1"  *ngIf="dataFound === true"> \n                <div class="list">\n           \n       <div class="row form-stacked-row" *ngIf="value_1 != null && value_2 != null && value_3 != null" >\n           <div class="col legend-box">\n                 <span class="legend-box-heading"></span>\n             \n\n\n             <div *ngIf="value_1 != null && value_2 != null" class="row form-stacked-row">\n\n                      <div *ngIf="value_1 != null" class="col col-50">\n                          <div >\n                                <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;" > {{label_1}} </span>\n                        <input  type="text" class="" name="feedback_field_51" [(ngModel)]="value_1" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" > <span class="percent-symbol">%</span>\n                              </label>\n                          </div>\n                      </div>\n\n                      <div class="col col-50" *ngIf="value_2 != null">\n                        <div  >\n                           <label class="item item-input item-stacked-label"> <span class="input-label" style="white-space:pre-wrap;" >  {{label_2}} </span>\n                        <input readonly="readonly" type="text" class="" name="feedback_field_52" [(ngModel)]="value_2" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >   \n                          </label>\n                        </div>\n                           </div>\n             </div>\n\n\n             <div class="row form-stacked-row" *ngIf="value_3 != null">\n                  <div class="col ">\n               <div >\n                    <label  class="item item-input item-stacked-label" >\n                    <span class="input-label" style="white-space:pre-wrap;" > {{label_3}} </span>\n                     <textarea class="" rows="8" cols="10" id="feedback_field_53" name="feedback_field_53" [(ngModel)]="value_3" ></textarea>\n                   </label>\n                </div>\n                  </div>\n              </div>\n          </div>\n        </div>\n\n\n       <div class="row form-stacked-row" *ngIf="value_4 != null && value_5 != null">\n           <div class="col legend-box">\n                 <span class="legend-box-heading"> Service  </span>\n             \n\n             <div class="row form-stacked-row" *ngIf="value_4 != null">\n                   <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" > {{label_4}} </span>\n                         <input readonly="readonly" type="text" class="" name="feedback_field_54" [(ngModel)]="value_4" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" > \n\n                       </label>\n                    </div>\n             </div>\n\n             <div class="row form-stacked-row" *ngIf="value_5 != null">\n                  <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" > {{label_5}} </span>\n                          <input readonly="readonly" type="text" class="" name="feedback_field_55"[(ngModel)]="value_5" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" > \n\n                       </label>\n                    </div>\n             </div>\n\n\n          </div>\n        </div>\n\n\n\n\n           <div *ngIf="value_6 != null">\n                <label  class="item item-input item-stacked-label" >\n                <span class="input-label" style="white-space:pre-wrap;" > {{label_6}}</span>\n                 <textarea class="" rows="8" cols="10" id="feedback_field_56" name="feedback_field_56" [(ngModel)]="value_6" ></textarea>\n               </label>\n            </div>\n                \n\n\n\n       <!-- <div class="row form-stacked-row" >\n           <div class="col legend-box">\n                 <span class="legend-box-heading"></span>\n\n\n             <div class="row form-stacked-row">\n                   <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;"></span>\n\n                     <input readonly="readonly" type="text" class="" name="feedback_field_57" ([ngModel])="feedback_field_57" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                       </label>\n                    </div>\n             </div>\n\n             <div class="row form-stacked-row">\n                    <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" >   </span>\n\n                        <input readonly="readonly" type="text" class="" name="feedback_field_58" ng-model="feedbackMonthlyFormData.feedback_field_58" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                       </label>\n                    </div>\n             </div>\n\n\n             <div class="row form-stacked-row">\n                   <div>\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" ></span>\n                        <input readonly="readonly" type="text" class="" name="feedback_field_59" ng-model="feedbackMonthlyFormData.feedback_field_59" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n                       </label>\n                    </div>\n             </div>\n\n             <div class="row form-stacked-row">\n                    <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" ></span>\n\n                        <input readonly="readonly" type="text" class="" name="feedback_field_60" ng-model="feedbackMonthlyFormData.feedback_field_60" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" >\n\n                       </label>\n                    </div>\n             </div>\n\n\n             <div class="row form-stacked-row">\n                  <div >\n                        <label  class="item item-input item-stacked-label" >\n                        <span class="input-label" style="white-space:pre-wrap;" ></span>\n                        <input readonly="readonly" type="text" class="" name="feedback_field_61" ng-model="feedbackMonthlyFormData.feedback_field_61" ng-maxlength="100" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"  >\n                       </label>\n                    </div>\n             </div>\n\n\n\n          </div>\n        </div> -->\n\n\n\n            </div>\n       \n	</form>\n	 <div class="list list1" *ngIf="dataFound === false">\n            <div class="no-box">  <img src=\'assets/imgs/icon-no-comment.png\'><div class="clearfix"> </div>\n            <h3 class="text-center">Feedback not given for this month.</h3>\n             </div>\n        </div>\n </ion-scroll>\n</ion-content>\n'/*ion-inline-end:"/opt/lampp/htdocs/ionic3/src/pages/view-feedback-form-monthly/view-feedback-form-monthly.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]])
