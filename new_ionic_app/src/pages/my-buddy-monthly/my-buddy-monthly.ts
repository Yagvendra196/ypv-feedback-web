          ...
          this.http.post(url, httpBody, {
            ...
            .subscribe(
                data => {
                    ...
                    this.feedback_fields_51 =  (obj.data[0].feedback_field_label == 'undefined') ? '' : obj.data[0].feedback_field_label;

                    this.feedback_fields_52 =  (obj.data[1].feedback_field_label == 'undefined') ? '' : obj.data[1].feedback_field_label;

                    this.feedback_fields_53 =  (obj.data[2].feedback_field_label == 'undefined') ? '' : obj.data[2].feedback_field_label;

                    this.feedback_fields_54 =  (obj.data[3].feedback_field_label == 'undefined') ? '' : obj.data[3].feedback_field_label;

                    this.feedback_fields_55 =  (obj.data[4].feedback_field_label == 'undefined') ? '' : obj.data[4].feedback_field_label;

                    this.feedback_fields_55 =  (obj.data[5].feedback_field_label == 'undefined') ? '' : obj.data[5].feedback_field_label
                    ...
                    this.http.post(url1, httpBody1, {
                        ...
                        .subscribe(
                            data => {
                                ...
                                this.feedback_field_id_1 =  (objViewFeedback.data[0].user_feedback_field_value == 'undefined') ? '' :  objViewFeedback.data[0].user_feedback_field_value;

                                this.feedback_field_id_2 =  (objViewFeedback.data[1].user_feedback_field_value == 'undefined') ? '' :  objViewFeedback.data[1].user_feedback_field_value;
