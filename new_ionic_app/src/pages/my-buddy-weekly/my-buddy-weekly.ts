                        ...
                        .subscribe(
                            data => {
                                ...
                                if (objViewFeedback.response == 'S') {
                                    ...
                                    this.feedback_field_id_3 =  (objViewFeedback.data[2].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[2].user_feedback_field_value;

                                    this.feedback_field_id_4 =  (objViewFeedback.data[3].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[3].user_feedback_field_value;

                                    this.feedback_field_id_5 =  (objViewFeedback.data[4].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[4].user_feedback_field_value;

                                    this.feedback_field_id_6 =  (objViewFeedback.data[5].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[5].user_feedback_field_value;

                                    this.feedback_field_id_7 =  (objViewFeedback.data[6].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[6].user_feedback_field_value;

                                    this.feedback_field_id_8 =  (objViewFeedback.data[7].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[7].user_feedback_field_value;

                                    this.feedback_field_id_9 =  (objViewFeedback.data[8].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[8].user_feedback_field_value;

                                    this.feedback_field_id_10 =  (objViewFeedback.data[9].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[9].user_feedback_field_value;

                                    this.feedback_field_id_11 =  (objViewFeedback.data[10].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[10].user_feedback_field_value;

                                    this.feedback_field_id_12 =  (objViewFeedback.data[11].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[11].user_feedback_field_value;

                                    this.feedback_field_id_13 =  (objViewFeedback.data[12].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[11].user_feedback_field_value;


                                    this.feedback_field_id_14 =  (objViewFeedback.data[13].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[13].user_feedback_field_value;

                                    this.feedback_field_id_15 =  (objViewFeedback.data[14].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[14].user_feedback_field_value;

                                    this.feedback_field_id_16 =  (objViewFeedback.data[15].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[15].user_feedback_field_value;

                                    this.feedback_field_id_17 =  (objViewFeedback.data[16].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[16].user_feedback_field_value;

                                    this.feedback_field_id_18 =  (objViewFeedback.data[17].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[17].user_feedback_field_value;
                                    
                                    this.feedback_field_id_19 =  (objViewFeedback.data[18].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[18].user_feedback_field_value;

                                    this.feedback_field_id_20 =  (objViewFeedback.data[19].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[19].user_feedback_field_value;

                                    this.feedback_field_id_21 =  (objViewFeedback.data[20].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[20].user_feedback_field_value;

                                    this.feedback_field_id_22 =  (objViewFeedback.data[21].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[21].user_feedback_field_value;

                                    this.feedback_field_id_23 =  (objViewFeedback.data[22].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[22].user_feedback_field_value;

                                    this.feedback_field_id_24 =  (objViewFeedback.data[23].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[23].user_feedback_field_value;

                                    this.feedback_field_id_25 =  (objViewFeedback.data[24].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[24].user_feedback_field_value;

                                    this.feedback_field_id_26 =  (objViewFeedback.data[25].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[25].user_feedback_field_value;

                                    this.feedback_field_id_27 =  (objViewFeedback.data[26].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[26].user_feedback_field_value;

                                    this.feedback_field_id_28 =  (objViewFeedback.data[27].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[27].user_feedback_field_value;

                                    this.feedback_field_id_29 =  (objViewFeedback.data[28].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[28].user_feedback_field_value;

                                    this.feedback_field_id_30 =  (objViewFeedback.data[31].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[31].user_feedback_field_value;

                                    this.feedback_field_id_31 =  (objViewFeedback.data[30].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[30].user_feedback_field_value;

                                    this.feedback_field_id_32 =  (objViewFeedback.data[31].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[31].user_feedback_field_value;

                                    this.feedback_field_id_33 =  (objViewFeedback.data[32].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[32].user_feedback_field_value;

                                    this.feedback_field_id_34 =  (objViewFeedback.data[33].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[33].user_feedback_field_value;

                                    this.feedback_field_id_35 =  (objViewFeedback.data[34].user_feedback_field_value == 'undefined') ? '' : objViewFeedback.data[34].user_feedback_field_value;
                                }
                            }, error => {
                                console.log(error);
                            }
