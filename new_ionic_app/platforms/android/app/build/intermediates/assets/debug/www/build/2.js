...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu__ = __webpack_require__(318);
...
var MenuPage = /** @class */ (function () {
    ...
    MenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-menu',template:/*ion-inline-start:"/opt/lampp/htdocs/ionic3/src/pages/menu/menu.html"*/'<style type="text/css">\n  .menu-btn{\n  color: rgb(246, 64, 65);\n}\n</style>\n<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n \n  <ion-content>\n    <ion-list>\n      <button class="menu-btn" ion-item menuClose *ngFor="let p of pages" (click)="openPage(p)">\n        <!--   <ion-icon item-start [name]="p.icon" [color]="isActive(p)"></ion-icon> -->\n          {{ p.title }}\n        </button>\n        <button class="menu-btn" ion-item (click)="logout()">\n          Logout\n        </button>\n    </ion-list>\n  </ion-content>\n</ion-menu>\n \n<!-- main navigation -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n\n'/*ion-inline-end:"/opt/lampp/htdocs/ionic3/src/pages/menu/menu.html"*/,
        }),
